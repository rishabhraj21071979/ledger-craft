...
export function sendEmail (recievermail){
    ...
    return new Promise((resolve, reject) => {
      ...
      const mail_configs = {
        ...
        subject: "FinancePulse dues reminder",
        html: `<!DOCTYPE html>
  <html lang="en" >
  <head>
    <meta charset="UTF-8">
  ...
  <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
      <div style="border-bottom:1px solid #eee">
        <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">FinancePulse</a>
      </div>
      <p style="font-size:1.1em">Hi,</p>
      <p>Thank you for choosing FinancePulse. Clear your dues as soon as possible</p>
